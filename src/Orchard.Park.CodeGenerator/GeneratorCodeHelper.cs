...
namespace Orchard.Park.CodeGenerator
{
    /// <summary>
    /// 自动生成代码
    /// </summary>
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                using (ZipArchive zip = new ZipArchive(ms, ZipArchiveMode.Create, false))
                {
                    ...
                    switch (fileType)
                    {
                        case "AllFiles":
                            //Controller
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.Controllers.Controller.tpl"), Encoding.UTF8))
                            {
                            ...
                            //IRespository
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.Repositories.IRepository.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //Respository
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.Repositories.Repository.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //IServices
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.Services.IServices.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //Services
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.Services.Services.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //Model
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.DbModel.Model.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //CreateHtml
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.View.Create.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //EditHtml
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.View.Edit.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //DetailsHtml
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.View.Details.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                            ...
                            //IndexHtml
                            using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.View.Index.tpl"), Encoding.UTF8))
                            {
                                file = reader.ReadToEnd();
                                template = Template.Parse(file);
                                result = template.Render(Hash.FromAnonymousObject(obj));
                        ...
                        switch (fileType)
                        {
                            case "AllFiles":
                                ...
                                using (var reader = new StreamReader(assembly.GetManifestResourceStream("Orchard.Park.CodeGenerator.CrudTemplete.DbModel.Model.tpl"), Encoding.UTF8))
                                {
                                    ...
                                    template = Template.Parse(file);
                                    result = template.Render(Hash.FromAnonymousObject(obj));
                                    ZipArchiveEntry entry1 = zip.CreateEntry("Entity/" + item.Name + "_Sugar.cs");
                                    using (StreamWriter entryStream = new StreamWriter(entry1.Open()))
                                    {
                                        entryStream.Write(result);
                                    }
