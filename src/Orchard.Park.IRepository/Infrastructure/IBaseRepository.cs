...
namespace Orchard.Park.IRepository.Infrastructure
{
    ...
    public interface IBaseRepository<T> where T : class, new()
    {
        ...
        /// <returns></returns>
        Task<List<TResult>> QueryListByClauseAsync<TResult>(Expression<Func<T, bool>> predicate,
        ...
        /// <returns></returns>
        Task<bool> UpdateAsync(List<T> entity, Expression<Func<T, object>> columns);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        Task<int> UpdateOrAddAsync(List<T> entity);
        ...
        /// <returns></returns>
        Task<bool> UpdateAsync(T entity, Expression<Func<T, bool>> where, Expression<Func<T, object>> ignoreColumn);
        ...
        /// <param name="blUseNoLock"></param>
        /// <returns></returns>
        Task<TResult> QueryMuchFirstAsync<TResult>(
